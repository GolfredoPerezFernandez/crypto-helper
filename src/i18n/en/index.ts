export default {
  app: {
    ...
    footer: {
      ...
      description:
        "A flexible ecosystem to manage NFT-based properties, sales, rentals and power delegation.",
      ecosystem: "Ecosystem",
      base: "Base Network",
      chainlink: "Chainlink",
      graph: "The Graph",
  ...
  tokenPage: {
    ...
    snapshotMoralis: "Cached snapshot · chain",
    colTx: "Tx",
    colFrom: "From",
    colTo: "To",
    colValue: "Value",
  ...
  home: {
    ...
    hero: {
      ...
      description:
        "The definitive platform to tokenize, trade, and manage real-world assets on the Base blockchain.",
    ...
    contracts: {
      ...
      subtitle:
        "Security-first architecture to manage NFT properties with KNRT tokens",
      realEstate: {
    ...
    ctaSection: {
      ...
      subtitle:
        "Combine sales, rentals, and temporary rights in one flow with KNRT payments.",
      create: "Create your first listing",
      view: "View dashboard",
    },
    footer: {
      flexibleStack:
        "Flexible stack to manage NFT-based properties: sales, rentals, and temporary rights with escrow, lock, and recall mechanics.",
      product: "Product",
      marketplace: "Marketplace",
      rental: "Rental",
      power: "Rights",
