...
export default component$(() => {
  ...
  return (
    <div class="mx-auto max-w-2xl px-4 py-16 text-slate-200">
      <h1 class="text-2xl font-bold text-white">Privacy</h1>
      <p class="mt-4 text-sm text-slate-400">
        Placeholder page. Replace this copy with your privacy policy and data practices.
      </p>
